    ...
    while($donnees = $response->fetch())
    {
        ...
        <div class="card border-dark mb-3 col-xs-1 col-sm-1 col-md-4">
            ...
            <div class="card-footer">
                     <small class="text-muted">  <a href="#" id="aj<?php echo $i?>" class="btn btn-primary" prix="<?php echo $donnees['prix'];?>" 
                     nom="<?php echo $donnees['nom'];?>" quantite=1 categorie="livre" idp="<?php echo $donnees['id'];?>"> ajouter au panier </a></small>
...
<div class="modal fade" id="infos<?php echo $i?>" role="dialog" aria-labelledby="modalTitre" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <script>
        ...
        $('#aj0').click(function() {
            $('#aj0').load('fonction_panier.php',{id:this.attr("idp"), nom:this.attr("nom"),quantite: this.attr("quantite"), prix: this.attr('prix'), categorie: this.attr('categorie'), code:1});
