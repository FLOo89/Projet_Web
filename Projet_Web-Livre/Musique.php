...
<nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="Musique.php"> <span class="sr-only">(current)</span>  <i class="fa fa-music"></i><span> Musique</span> </a>
  ...
  <header class="page-header song header container-fluid">
        <script type="text/javascript">
            $('document').ready( function(){
                $('.song').height($(window).height()/2);
            })
        </script>
...
<?php
    $i=0; 
    $response = $bdp->query('SELECT * FROM musique');
